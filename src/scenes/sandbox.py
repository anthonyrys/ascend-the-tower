...
from src.entities.terrain.barrier import Barrier
...
class Sandbox(Scene):
    def __init__(self, surfaces, sprites=...):
        ...
        player = Player(pygame.Vector2(900, 1125), 2)
        ...
        barrier_a = Barrier(pygame.Vector2(500, 1200), pygame.Vector2(300, 100), COLORS[0], player)
        barrier_b = Barrier(pygame.Vector2(950, 1200), pygame.Vector2(250, 50), COLORS[1], player)
        barrier_c = Barrier(pygame.Vector2(1300, 1250), pygame.Vector2(75, 250), COLORS[2], player)
        barrier_d = Barrier(pygame.Vector2(1450, 1250), pygame.Vector2(75, 250), COLORS[0], player)
        barrier_e = Barrier(pygame.Vector2(1700, 1250), pygame.Vector2(150, 250), COLORS[1], player)
        barrier_f = Barrier(pygame.Vector2(2000, 1350), pygame.Vector2(250, 50), COLORS[2], player)
    ...
    def display(self, screen):
        ...
        self.background.display(self.background_surface)

        display_order = self.sort_sprites(self.sprites)
        for i, v in sorted(display_order.items()):
            for sprite in v: 
